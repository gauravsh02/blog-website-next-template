                                                        ...
                                                        <div className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                                                            ...
                                                            <div className="space-y-5 xl:col-span-3">
                                                                ...
                                                                <div className="text-base font-medium leading-6">
                                                                    <a href={"posts/"+post.slug} className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" aria-label="Read &quot;Thoughts on life and death&quot;">Read more →</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
