    ...
    return (
        <>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div className="grid grid-cols-1 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <div className="mb-6 md:mb-0">
                            <a href="" className="flex items-center">
                                <Image src={'/images/logo.svg'} alt={'logo'} width={100} height={60} />
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white p-5">LOGO</span>
                            </a>
                        </div>
                    </div>
                    <div>
                ...
                <div className="flex items-center justify-center">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" className="hover:underline">logo</a>. All Rights Reserved.</span>
                </div>
            </footer>
        </>
    );
